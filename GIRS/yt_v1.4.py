...
NOTIFY_RE = re.compile(
    r"go order|evac order|mandatory evacuation|reverse 911|"
    r"wireless emergency alert|WEA|nixle|alert la|text alert|watch duty",
    re.I
)
...
DETECTION_RE = re.compile(
    r"ash|glow|orange sky|embers|smelled smoke|saw smoke",
    re.I
)
